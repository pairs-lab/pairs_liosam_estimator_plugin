...
# dependency .debs from /prebuilt, then builds pairs_liosam_estimator_plugin and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_liosam_estimator_plugin/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_liosam_estimator_plugin
